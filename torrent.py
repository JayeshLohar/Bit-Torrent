...
class Torrent(object):
    def __init__(self,path):
        ...
        if self.total_length < KB:
            print("Total Length", self.total_length,"Bytes")
        elif self.total_length < MB:
            print("Total Length", round(self.total_length/KB, 2),"KBytes")
        elif self.total_length < GB:
            print("Total Length", round(self.total_length/MB, 2),"MBytes")
        else:
            print("Total Length", round(self.total_length/GB, 2),"GBytes")
...
# def parse_torrent():
#     torrent=Torrent("torrent_files/music.torrent")
#     print(torrent.total_length)
