...
# torrent=torrent.Torrent("torrent_files/Lamb.torrent")
# torrent=torrent.Torrent("torrent_files/ubuntu-20.04.3-desktop-amd64.iso.torrent")
...
class udp_tracker():
    ...
    def parse_connection_response(self, raw_connection_data):
        ...
        if response_action == 0x3:
            ...
            # print('UDP tracker reponse error : ' + error_msg)
    ...
    def parse_udp_tracker_response(self, raw_announce_reponse):
        ...
        if response_action != 0x1:
            ...
            # print("Error while annoucing: %s" % error_msg)
...
class Tracker():
    ...
    def get_peers_from_trackers(self,torrent):
        ...
        for tracker_url in self.tracker_urls:
            if tracker_url not in self.active_trackers:
                th = Thread( target = self.get_peers, args=( torrent, tracker_url, p_list ))
...
if __name__ == '__main__':
    t=Torrent("torrent_files/t5.torrent")
    tracker=Tracker(t)
    tracker=tracker.get_peers_from_trackers(t)
    print(tracker.peer_list)
